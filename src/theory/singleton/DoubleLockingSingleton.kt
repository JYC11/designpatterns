...
thread.
Every time we want to retrieve the theory.singleton instance, we perform a null check.
If the theory.singleton instance has already been created, we return it.
