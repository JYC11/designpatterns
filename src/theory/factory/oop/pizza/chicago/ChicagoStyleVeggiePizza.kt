package theory.factory.oop.pizza.chicago
...
import theory.factory.oop.pizza.base.VeggiePizza

data class ChicagoStyleVeggiePizza(
...
) : VeggiePizza(name, ingredientFactory, dough, sauce, cheese, pepperoni, vegetables, anchovy)